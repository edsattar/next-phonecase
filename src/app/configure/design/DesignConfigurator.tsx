            ...
            <div className="relative mt-4 h-full flex flex-col justify-between">
              <div className="flex flex-col gap-6">
                ...
                >
                  ...
                  <div className="pt-3 flex items-center gap-x-3 h-12">
                    {COLORS.map((color) => (
                      <Radio
                        key={color.label}
                        value={color}
                      ...
                      <div className="mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          <Radio
                            key={option.value}
                            value={option}
                            className="relative block cursor-pointer rounded-lg bg-white px-6 py-4 shadow-sm border-2 border-zinc-200 sm:flex sm:justify-between aria-checked:border-primary"
                          >
